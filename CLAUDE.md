...
- `/` — Home (AI insight card with Claude orange left-accent bar and "Claude's take" eyebrow label, income vs expenses horizontal bars (independently scaled, no Recharts) with net summary and savings rate badge, net worth month-over-month change card with sparkline, category spend card with filter pills, top/worst investment performer cards). Three-column grid layout on desktop (6fr_3fr_3fr), stacks on mobile.
